                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            <a title="This questionanswer is useful" class="vote-up">
                                <i class="fas fa-caret-up fa-3x"></i>
                            </a>
                            <span class="votes-count">1230</span>
                            <a title="This questionanswer is not useful" class="vote-down off">
                    ...
                    @foreach ($question->answers as $answer)
                        <div class="media">
                            ...
                            <div class="media-body">
                                {!! $answer->body_html !!}
                                <div class="float-right">
                                    <span class="text_muted">Answered {{ $answer->created_date }}</span>
                                    <div class="media mt-2">
